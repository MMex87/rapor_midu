...
const { DeleteUser, getSuper, getUsers, getUsersId, Login, Logout, Register, UpdateEmail, UpdatePass, UpdateProfil, UpdateUser, getTahunAjar } = require("../controllers/Users.js")
...
const { getMapel, getMapelId, editMapel, hapusMapel, tambahMapel, getMapelKelas, getMapelRapor, getMapelCountKelas, getMapelTahun } = require("../controllers/Mapel.js")
...
router.get('/usersTahun/:email', getTahunAjar)
...
router.get('/guruUname/:uname', guru.getTahunAjar)
router.get('/guruWali', verifyToken, guru.getGurusWali)
...
// Kelas
router.get('/kelas/:tahun/:tahun2', verifyToken, kelas.getKelas)
router.get('/kelasGuru/:idGuru', verifyToken, kelas.getKelasGuru)
router.get('/kelasId/:id', verifyToken, kelas.getKelasId)
...
// Mapel
router.get('/mapel/:tahun/:tahun2', verifyToken, getMapelTahun)
...
router.get('/tahunAjarPage', verifyToken, tahun.getTahunPage)
router.get('/tahunAjarLogin', tahun.getTahunLogin)
