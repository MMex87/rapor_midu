...
export const RaporUtsGenap = (props) => {
    // alert
    ...
    return (
        <>
            <div className="card-header row">
                <h3 className="card-title col-sm-4">Daftar Siswa UTS Genap</h3>
...
export default connect(mapStateToProps, mapDispatchToProps)(RaporUtsGenap)