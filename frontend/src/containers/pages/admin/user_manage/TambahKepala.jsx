...
export const TambahKepala = (props) => {
    ...
    const [password, setPassword] = useState('kepsekmidu')
    const [confPassword, setConfPassword] = useState('kepsekmidu')
                        ...
                        <div className="row mb-2">
                            ...
                            <div className="col-sm-6">
                                <ol className="breadcrumb float-sm-right">
                                    ...
                                    <li className="breadcrumb-item"><Link to={ "/user" }>User Manage</Link></li>
                                    <li className="breadcrumb-item active">Tambah Kepala Sekolah</li>
                                </ol>
                            </div>{/* /.col */ }
                        </div>{/* /.row */ }
                    </div>{/* /.container-fluid */ }
                        ...
                        <div className="col-12">
                            <div className="card">
                                <div className="card-header row">
                                    <h3 className="card-title col-4">Tambah User Kepala Sekolah</h3>
                                ...
                                <div className="card-body table-responsive p-5">
                                    <div className="col-md-10">
                                        <div className="form-group">
                                            <form onSubmit={ tambahKepala }>
                                                <div className="field">
                                                    <p>Default Password: kepsekmidu</p>
                                                </div>
...
export default connect(mapStateToProps, mapDispatchToProps)(TambahKepala)